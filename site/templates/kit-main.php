				...
				<li>
					...
					<ul class="download_multi_lang">
						<?php foreach(page()->download_final_doc_pdfs()->toStructure() as $itemdd): ?>
							<li><a href="<?php echo page()->document($itemdd->pdf())->url()  ?>" target="_blank"><?php echo $itemdd->lang() ?></a></li>
						<?php endforeach ?>
					</ul>
				</li>
				<li>
					...
					<ul class="download_multi_lang">
						<?php foreach(page()->download_final_poster_pdfs()->toStructure() as $itempp): ?>
							<li><a href="<?php echo page()->document($itempp->pdf())->url() ?>" target="_blank"><?php echo $itempp->lang() ?></a></li>
						<?php endforeach ?>
					</ul>
				</li>
			</ul>
